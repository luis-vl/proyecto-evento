 ...
 * @author luisv
 */
public class DialogServicio extends javax.swing.JDialog {

    /**
     * Creates new form DialogServicio
     */
    public DialogServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogServicio dialog = new DialogServicio(new javax.swing.JFrame(), true);
