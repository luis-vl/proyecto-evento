 ...
 * @author luisv
 */
public class DialogContratarServicio extends javax.swing.JDialog {

    /**
     * Creates new form DialogServicio
     */
    public DialogContratarServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogContratarServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogContratarServicio dialog = new DialogContratarServicio(new javax.swing.JFrame(), true);
